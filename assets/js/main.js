...
const SCRIPT = [
  ...
  {cmd:'cat ./now.txt', out:['正在研究 ▸ <span class="hl">Transformer</span> 与 <span class="hl">RAG</span>','正在构建 ▸ 可调用工具的 AI Agent']},  {cmd:'uptime', out:['blog online <span class="am">0</span> days · focus: RAG · status: online']}
];
