...
const SCRIPT = [
  ...
  {cmd:'cat ./now.txt', out:['正在攻坚 ▸ 用 <span class="hl">eBPF</span> 重写服务网格数据面','正在阅读 ▸ 《数据密集型应用系统设计》第 8 章']},  {cmd:'uptime', out:['blog online <span class="am">0</span> days · 42 posts · load average: 0.42, 0.38, 0.36']}
];
